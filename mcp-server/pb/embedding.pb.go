...
const file_embedding_proto_rawDesc = "" +
	...
	"\x06Vector\x12\x16\n" +
	"\x06values\x18\x01 \x03(\x02R\x06values2^\n" +
	"\x10EmbeddingService\x12J\n" +
	"\rGetEmbeddings\x12\x1b.embedding.EmbeddingRequest\x1a\x1c.embedding.EmbeddingResponseB\x06Z\x04./pbb\x06proto3"
...
var file_embedding_proto_goTypes = []any{
	...
	(*Vector)(nil),            // 2: embedding.Vector
}
var file_embedding_proto_depIdxs = []int32{
	2, // 0: embedding.EmbeddingResponse.vectors:type_name -> embedding.Vector
	0, // 1: embedding.EmbeddingService.GetEmbeddings:input_type -> embedding.EmbeddingRequest
	1, // 2: embedding.EmbeddingService.GetEmbeddings:output_type -> embedding.EmbeddingResponse
